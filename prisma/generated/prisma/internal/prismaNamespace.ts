...
export const PendingDeliveryScalarFieldEnum = {
  id: 'id',
  winner_steam_id: 'winner_steam_id',
  asset_id: 'asset_id',
  item_name: 'item_name',
  status: 'status',
...
export const PendingDeliveryOrderByRelevanceFieldEnum = {
  winner_steam_id: 'winner_steam_id',
  asset_id: 'asset_id',
  item_name: 'item_name',
  trade_offer_id: 'trade_offer_id'
...
export type PendingDeliveryOrderByRelevanceFieldEnum = (typeof PendingDeliveryOrderByRelevanceFieldEnum)[keyof typeof PendingDeliveryOrderByRelevanceFieldEnum]
